...
estimator = KerasRegressor(build_fn=baseline_model, epochs=10, batch_size=10, verbose=1)
...
for i in range(iterations):
	...
	#Train the model
	estimator.fit(Xtrain, ytrain, epochs=epoch_count, batch_size=10, verbose=1)
