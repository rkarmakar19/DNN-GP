...
for i in range(iterations):
	...
	#Train the model
	estimator.fit(Xtrain, ytrain, epochs=epoch_count, batch_size=10, verbose=0)
	...
	print("Iteration = %d   NRMSE = %4.3f" % (i,nrmse))
...
np.savetxt("DNN-nrmse.dat",nrmse_list, fmt="%4.3f") 
